...
//extern是外部关键字，作用于全局变量或者是函数。
extern const string pointCloudTopic = "/velodyne_points";  //点云消息名称
extern const string imuTopic = "/imu/data";    //imu消息名称

// Save pcd
extern const string fileDirectory = "/home/cxl/workspace/LOAM-set/LeGO-LOAM/src/pcd";
...
// ——————————————————————————激光雷达定义——————————————————————————————————————————
// VLP-16
extern const int N_SCAN = 16;  //激光线束
extern const int Horizon_SCAN = 1800;  //水平分辨率360/1800
extern const float ang_res_x = 0.2;    //水平分辨率
extern const float ang_res_y = 2.0;    //垂直分辨率
extern const float ang_bottom = 15.0+0.1;  //与水平方向夹角
extern const int groundScanInd = 7;     //扫描地面的点
...
extern const bool loopClosureEnableFlag = true;  //是否进行回环检测
extern const double mappingProcessInterval = 0.3;//建图优化处理时间

extern const float scanPeriod = 0.1; //扫描周期
extern const int systemDelay = 0;
extern const int imuQueLength = 200; //imu数列长度
//点云分割的一些设置
